...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 12 2017 г., 03:38
...
(30, 'Product 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 17, '2009-02-03 16:59:00', '2017-04-09 22:39:37'),
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'catalog/prod_big.jpg', 8, 1, '100.0000', 0, 9, '2009-02-04', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 371, '2009-02-03 21:07:37', '2017-04-12 02:56:58'),
...
(47, 'Product 21', '', '', '', '', '', '', '', 1000, 5, 'catalog/demo/hp_1.jpg', 7, 1, '100.0000', 400, 9, '2009-02-03', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 22, '2009-02-03 21:08:40', '2011-09-30 01:05:28'),
...
(2504, 42, 'catalog/prod3.png', 0),
(2503, 42, 'catalog/prod.png', 0),
(2502, 42, 'catalog/man.jpg', 0),
(2501, 42, 'catalog/man2.jpg', 0),
(2500, 42, 'catalog/prod_1.jpg', 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=112317 DEFAULT CHARSET=utf8;
...
(955, 'product_id=42', 'test'),
(912, 'product_id=30', 'canon-eos-5d'),
...
--
-- Индексы таблицы `oc_product_label`
--
ALTER TABLE `oc_product_label`
...
--
ALTER TABLE `oc_collections_images`
  MODIFY `id_collections_images` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=188;
--
...
--
ALTER TABLE `oc_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1470;
--
...
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=258;
--
...
--
-- AUTO_INCREMENT для таблицы `oc_product_label`
--
ALTER TABLE `oc_product_label`
  MODIFY `product_label_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=112317;
--
-- AUTO_INCREMENT для таблицы `oc_special_offers`
--
ALTER TABLE `oc_special_offers`
  MODIFY `special_offers_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT для таблицы `oc_special_offers_images`
--
ALTER TABLE `oc_special_offers_images`
  MODIFY `id_special_offers_images` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=141;
--
